...
//Permet de renvoyer une chaine concat�n�e
string returnChaine()
{
    ostringstream oss;
    string pren = "Steeve";
...
Destruction du Cercle
    ...
    */
    ...
    � la methode affiche non pas en fonction du type de l'objet d�clar� (ici Point)
    mais en fonction du type de l'�l�ment r�ellement instanc� (ici PointCouleur)
